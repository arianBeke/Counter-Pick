    ...
    <div>
      ...
      <div className=" mt-32">
        <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
          ...
          >
            {dva.map((dva) => (
              <li key={dva.name} className="rounded-2xl grid grid-cols-2   ring-[#00df9a] ring-4 bg-[#1D2128] px-8 py-10">
                <div className=" pr-52">
                    ...
                    leaveTo="transform scale-95 opacity-0">
                      <Disclosure.Panel as="dd" className="mt-2 pr-12">
                        <div className=" mt-9 grid grid-cols-1 lg:grid-cols-8 gap-8">
                          ...
                          <div className="flex flex-col items-center">
                            <img style={{ objectFit: 'scale-down' }} className="mx-auto lg:h-40 lg:w-28 bg-[#1D2128] ring-[#00df9a] ring-4 rounded-full" src={faq.img7} alt="" />
                            <p className="text-center text-white mt-5">CALL MECH</p>
                          </div>
                          <div className="flex flex-col items-center">
                            <img style={{ objectFit: 'scale-down' }} className="mx-auto lg:h-40 lg:w-28 bg-[#1D2128] ring-[#00df9a] ring-4 rounded-full" src={faq.img8} alt="" />
              ...
              <Disclosure key={counters[0].title} as="div" className="pt-6">
                {({ open }) => (
                  <>
                    ...
                    leaveFrom="transform scale-100 opacity-100"
                    leaveTo="transform scale-95 opacity-0">
                    <Disclosure.Panel as="dd" className="mt-2 overflow-hidden transition-height duration-300 ease-in-out pr-12">
